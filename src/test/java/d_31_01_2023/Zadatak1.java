...
public class Zadatak1 {
    public static void main(String[] args) throws InterruptedException {
        ...
        addImage(wait, driver, "test_data/left.jpg",2);
        addImage(wait, driver, "test_data/right.jpg",3);
        addImage(wait, driver, "test_data/back.jpg",4);


        wait.until(ExpectedConditions.elementToBeClickable(By.id("next-button")));
        driver.findElement(By.id("next-button")).click();
        driver.findElement(By.id("textareaID")).sendKeys("KAD CE TA MATURA ?!");
        driver.findElement(By.id("next-button")).click();
        driver.findElement(By.id("next-button")).click();
        driver.findElement(By.id("next-button")).click();
