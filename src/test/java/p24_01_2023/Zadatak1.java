...
//        driver.findElement(By.name("s")).sendKeys("Flying Ninja");
        driver.findElement(By.xpath("//*[@name='s']"))
                .sendKeys("Flying Ninja");
//        <p class="paragraf1 para2 p3">neki tekst</p>
//        driver.findElement(By.className("p")).click();

        driver.findElement(By.xpath("//*[contains(@class, 'search-submit')]"))
                .click();
